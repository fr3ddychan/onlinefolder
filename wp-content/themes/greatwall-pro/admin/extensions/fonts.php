...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'greatwall-pro' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'greatwall-pro' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'greatwall-pro' ),
		'cyrillic'     => __( 'Cyrillic', 'greatwall-pro' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'greatwall-pro' ),
		'devanagari'   => __( 'Devanagari', 'greatwall-pro' ),
		'greek'        => __( 'Greek', 'greatwall-pro' ),
		'greek-ext'    => __( 'Greek Extended', 'greatwall-pro' ),
		'khmer'        => __( 'Khmer', 'greatwall-pro' ),
		'latin'        => __( 'Latin', 'greatwall-pro' ),
		'latin-ext'    => __( 'Latin Extended', 'greatwall-pro' ),
		'vietnamese'   => __( 'Vietnamese', 'greatwall-pro' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'greatwall-pro' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'greatwall-pro' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'greatwall-pro' ),
