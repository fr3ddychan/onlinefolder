...
class GreatWall_Pro_Home_Contact_Info extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array('classname' => 'greawall_pro_contact_widget', 'description' => __( 'Display your contact info on your front page', 'greatwall-pro') );
        parent::__construct(false, $name = __('Home - Contact', 'greatwall-pro'), $widget_ops);
	...
	<p><label for="<?php echo $this->get_field_id( 'above_address' ); ?>"><?php _e( 'A short call to action above your address', 'greatwall-pro' ); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id( 'above_phone' ); ?>"><?php _e( 'A short call to action above your phone number', 'greatwall-pro' ); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id( 'above_email' ); ?>"><?php _e( 'A short call to action above your email address', 'greatwall-pro' ); ?></label>
