 ...
 * @since      1.0.0
 */
class greatwall_pro_Views_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-greatwall_pro-views widget_posts_thumbnail',
			'description' => __( 'Display the most viewed posts with thumbnails.', 'greatwall-pro' )
		);

		// Create the widget.
		parent::__construct(
			'greatwall_pro-views',                                        // $this->id_base
			__( '&raquo; Most Viewed Posts', 'greatwall-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Most Viewed Posts', 'greatwall-pro' ),
			'limit'     => 5,
			'show_date' => true
		);
