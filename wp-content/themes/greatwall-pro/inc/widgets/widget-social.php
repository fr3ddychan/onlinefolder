 ...
 * @since      1.0.0
 */
class greatwall_pro_Social_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-greatwall_pro-social widget_social_icons',
			'description' => __( 'Display your social media icons.', 'greatwall-pro' )
		);

		// Create the widget.
		parent::__construct(
			'greatwall_pro-social',                        // $this->id_base
			__( '&raquo; Social Icons', 'greatwall-pro' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'      => esc_html__( 'Follow Us', 'greatwall-pro' ),
			'desc'       => esc_html__( 'Stay updated via social channels', 'greatwall-pro' ),		
			'facebook'   => '',
			'twitter'    => '',
			'gplus'      => '',
			'pinterest'  => '',
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'desc' ); ?>">
				<?php _e( 'Description', 'greatwall-pro' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'gplus' ); ?>">
				<?php _e( 'Google Plus', 'greatwall-pro' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'pinterest' ); ?>">
				<?php _e( 'Pinterest', 'greatwall-pro' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'instagram' ); ?>">
				<?php _e( 'Instagram', 'greatwall-pro' ); ?>
			</label>
