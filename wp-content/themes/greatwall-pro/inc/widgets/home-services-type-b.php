...
class GreatWall_Pro_Services_Type_B extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'greawall_pro_services_b_widget', 'description' => __( 'Show what services you are able to provide.', 'greatwall-pro') );
        parent::__construct(false, $name = __('Home - Services - B', 'greatwall-pro'), $widget_ops);
		$this->alt_option_name = 'greawall_pro_services_b_widget';
	...
	<p>
	<label for="<?php echo $this->get_field_id('cols'); ?>"><?php _e( 'Number of columns:', 'greatwall-pro' ); ?></label>
			...
			<?php if ( $title ) echo $before_title . $title . $after_title; ?>
				...
				<div class="roll-icon-list">
					<?php while ( $services->have_posts() ) : $services->the_post(); ?>
						...
						<div class="service clear <?php echo $cols_no; ?>">
							<div class="list-item">
